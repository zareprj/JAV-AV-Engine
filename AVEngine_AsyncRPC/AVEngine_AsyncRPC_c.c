...
static const RPC_CLIENT_INTERFACE AVEngine_AsyncRPC___RpcClientInterface =
    {
...
RPC_IF_HANDLE AVEngine_AsyncRPC_v1_0_c_ifspec = (RPC_IF_HANDLE)& AVEngine_AsyncRPC___RpcClientInterface;

extern const MIDL_STUB_DESC AVEngine_AsyncRPC_StubDesc;

static RPC_BINDING_HANDLE AVEngine_AsyncRPC__MIDL_AutoBindHandle;
    ...
    /* [out] */ eOperationResualtState *_eOperationResualtState)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                      (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[0],
                      ( unsigned char * )&AsyncStartScan_AsyncHandle);
    ...
    /* [out] */ ScanEndJobReport *_scanEndJobReport)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                  (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[40],
    ...
    /* [out] */ eOperationResualtState *_eOperationResualtState)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                  (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[74],
                  ( unsigned char * )&hBinding);
    ...
    /* [out] */ eOperationResualtState *_eOperationResualtState)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                  (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[108],
                  ( unsigned char * )&hBinding);
    ...
    /* [out] */ eOperationResualtState *_eOperationResualtState)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                      (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[142],
                      ( unsigned char * )&AsyncStopScan_AsyncHandle);
    ...
    /* [out] */ eOperationResualtState *_eOperationResualtState)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                      (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[176],
                      ( unsigned char * )&AsyncSaveAndExit_AsyncHandle);
    ...
    /* [out] */ StatusMessage *_StatusMessage)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                      (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[210],
                      ( unsigned char * )&AsyncGetStatusMessage_AsyncHandle);
    ...
    /* [out] */ ScanMessage *_ScanMessage)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                      (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[244],
                      ( unsigned char * )&AsyncGetNextMessageScan_AsyncHandle);
    ...
    /* [out] */ eOperationResualtState *_eOperationResualtState)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                      (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[278],
                      ( unsigned char * )&AsyncStartQuarantine_AsyncHandle);
    ...
    /* [out] */ unsigned int *pu32Count)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                      (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[312],
                      ( unsigned char * )&AsyncGetQuarantineCount_AsyncHandle);
    ...
    /* [out] */ eOperationResualtState *_eOperationResualtState)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                      (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[346],
                      ( unsigned char * )&AsyncMoveFileToQuarantine_AsyncHandle);
    ...
    /* [out] */ eOperationResualtState *_eOperationResualtState)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                      (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[392],
                      ( unsigned char * )&AsyncGetQuarantinedFileInfo_AsyncHandle);
    ...
    /* [in] */ unsigned int *pu32Index)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                      (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[438],
                      ( unsigned char * )&AsyncRemoveFileFromQuarantine_AsyncHandle);
    ...
    /* [in] */ BigString *pszPathToExtract)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                      (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[478],
                      ( unsigned char * )&AsyncRestore_AsyncHandle);
    ...
    handle_t hBinding)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&AVEngine_AsyncRPC_StubDesc,
                  (PFORMAT_STRING) &AVEngine_AsyncRPC__MIDL_ProcFormatString.Format[524],
                  ( unsigned char * )&hBinding);
...
static const MIDL_STUB_DESC AVEngine_AsyncRPC_StubDesc = 
    {
    (void *)& AVEngine_AsyncRPC___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &AVEngine_AsyncRPC__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
